...
public interface DataBaseInitI {
    ...
    List<Firestations> instantiateListFirestations(List<Map<String, String>> firestations);
    List<MedicalRecords> instantiateListMedicalRecords(List<Map<String, Object>> medicalRecords);
    void saveAllList(List<Persons> persons, List<Firestations> firestations, List<MedicalRecords> medicalRecords);
