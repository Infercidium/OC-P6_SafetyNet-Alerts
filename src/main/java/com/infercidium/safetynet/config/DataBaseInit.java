...
public class DataBaseInit {
    ...
    public CommandLineRunner beginInit() {
        return args -> {
            ...
            LOGGER.debug("Deserialization of the String in a Map<String, Object>");
            ...
            LOGGER.debug("Instantiating and saving the list of persons in H2 table");
            dbis.instanciateListFirestations(firestations);
            LOGGER.debug("Instantiating and saving the list of firestations in H2 table");
            dbis.instanciateListMedicalRecords(medicalRecords);
            LOGGER.debug("Instantiating and saving the list of medicalRecords in H2 table");
            //Fin
