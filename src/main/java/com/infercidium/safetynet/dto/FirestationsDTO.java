...
public class FirestationsDTO {
     ...
     */
    public @NotBlank(message = "Address cannot be null or empty.") Set<String> getAddress() {
        return address;
    }
     ...
     */
    public void setAddress(final @NotBlank(message = "Address cannot be null or empty.") Set<String> addressS) {
